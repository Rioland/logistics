...
// import 'package:login/animation/RotationRoute.dart';
import 'package:login/animation/ScaleRoute.dart';
import 'package:login/screens/fooddelivery/pages/FoodDetailsPage.dart';
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Column(
        children: <Widget>[
          Container(
            padding: EdgeInsets.only(left: 10, right: 5, top: 5, bottom: 3),
