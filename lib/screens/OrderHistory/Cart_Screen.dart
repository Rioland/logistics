...
import 'package:login/screens/OrderHistory/item_screen.dart';
...
class Item {
  ...
  Item({required this.itemImage, required this.itemName, required this.itemQun, required this.itemPrice});
}
...
class Cart extends State<Cart_screen> {
  ...
  Widget build(BuildContext context) {
    ...
    // theme.textTheme.copyWith(color: theme.textTheme.caption.color);
