import 'package:login/screens/OrderHistory/Cart_Screen.dart';
import 'package:login/screens/OrderHistory/item_details.dart';
...
class Item_Screen extends StatefulWidget {
  ...
  Item_Screen({Key? key, required this.toolbarname}) : super(key: key);
...
class Item {
  ...
  Item({required this.itemname, required this.imagename, required this.itmprice});
}
...
class TravelDestinationItem extends StatelessWidget {
  TravelDestinationItem({Key? key, required this.destination, required this.shape})
